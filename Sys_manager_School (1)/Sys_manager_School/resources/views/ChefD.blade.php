        ...
        <div class="col-lg-6 align-self-center">
          <div class="caption header-text">
            @if(isset($chefd))
              ...
              <h6>Welcome  {{ $chefd->nom_prenom }} ! </h6>          
                  <div>
                      <h2>Your Information:</h2>
                      <ul>
                          <li><p>Date de naissance: {{ $chefd->date_de_naissance }}</p></li>
                          <li><p>CIN: {{ $chefd->cin }}</p></li>
                          <li><p>Departement: {{ $chefd->department }}</p></li>
  ...
  <div class="features">
    <div class="container">
      ...
      <div class="col-lg-3 col-md-6">
          <a href="{{ url('/manage-department-schedule') }}">
            <div class="item">
              <div class="image">
              ...
              <h4>Department Schedule</h4>
               ...
               <div class="col-lg-3 col-md-6">
          <a   href="{{ url('/manage-department-announcements') }}">
            <div class="item">
              <div class="image">
                <img src="assets/images/featured-04.png" alt="" style="max-width: 44px;">
              </div>
              <h4>Department Announcements</h4>
            </div>
          </a>
        </div>
      </div>
