        ...
        <div class="col-lg-6 align-self-center">
          <div class="caption header-text">
            @if(isset($cheff))
              ...
              <h6>Welcome  {{ $cheff->nom_prenom }} ! </h6>          
                  <div>
                      <h2>Your Information:</h2>
                      <ul>
                          <li><p>Date de naissance: {{ $cheff->date_de_naissance }}</p></li>
                          <li><p>CIN: {{ $cheff->cin }}</p></li>
                          <li><p>Filiére: {{ $cheff->filiere }}</p></li>
          ...
          <a href="{{ url('/Fannouncements') }}">
            <div class="item">
              ...
              <h4>Manage Announcements</h4>
               ...
               <div class="col-lg-3 col-md-6">
          <a   href="{{ url('/respond-to-student-requests') }}">
            <div class="item">
              <div class="image">
                <img src="assets/images/featured-04.png" alt="" style="max-width: 44px;">
              </div>
