        ...
        <div class="col-lg-6 align-self-center">
          <div class="caption header-text">
            @if(isset($student))
              ...
              <h6>Welcome  {{ $student->nom_prenom }} ! </h6>          
                  <div>
                      <h2>Your Information:</h2>
                      <ul>
                          <li><p>Date de naissance: {{ $student->date_de_naissance }}</p></li>
                          <li><p>Adresse: {{ $student->adresse }}</p></li>
                          <li><p>Code Massar: {{ $student->code_massar }}</p></li>
                          <li><p>CIN: {{ $student->cin }}</p></li>
                          <li><p>Filière: {{ $student->filiere }}</p></li>
                          <li><p>Group: {{ $student->Groupe }}</p></li>
  ...
  <div class="features">
    <div class="container">
      ...
      <div class="col-lg-3 col-md-6">
        ...
        <div class="col-lg-3 col-md-6">
          <a  href="{{ url('/student/recommendations') }}">
            <div class="item">
              <div class="image">
                <img src="assets/images/featured-04.png" alt="" style="max-width: 44px;">
              </div>
        ...
        <div class="col-lg-3 col-md-6">
          <a href="{{ url('/student/report-issue') }}">
            <div class="item">
              <div class="image">
                <img src="assets/images/featured-04.png" alt="" style="max-width: 44px;">
              </div>
